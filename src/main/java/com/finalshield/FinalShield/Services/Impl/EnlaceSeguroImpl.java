...
import com.finalshield.FinalShield.DTO.Correo.ArchivoCorreoDTO;
import com.finalshield.FinalShield.DTO.Correo.CorreoDTO;
import com.finalshield.FinalShield.Model.*;
import com.finalshield.FinalShield.Repositorios.ArchivoCorreoRepositorio;
import com.finalshield.FinalShield.Repositorios.CorreoRepositorio;
import com.finalshield.FinalShield.Repositorios.EnlaceSeguroRepositorio;
import com.finalshield.FinalShield.Repositorios.RecepcionCorreoRepositorio;
    ...
    public Optional<CorreoDTO> validarToken(String token, String correoUsuario) {
        return enlaceSeguroRepositorio.findByTokenUnico(token)
                ...
                .map(enlaceSeguro -> {
                    ...
                    recepcion.setFechaRecepcion(LocalDateTime.now(ZoneId.of("UTC")));
